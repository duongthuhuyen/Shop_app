...
import jp.techacademy.huyen.duong.shop_app.databinding.ActivityFoodSendBinding
import java.io.ByteArrayOutputStream

class FoodSendActivity : AppCompatActivity(), View.OnClickListener,
    DatabaseReference.CompletionListener {
    companion object {
        private const val PERMISSIONS_REQUEST_CODE = 100
    }

    private lateinit var binding: ActivityFoodSendBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFoodSendBinding.inflate(layoutInflater)
    ...
    override fun onClick(v: View) {
        if (v === binding.imageView) {
            ...
            val genreRef = dataBaseReference.child(FoodsPATH).child(genre.toString())
            ...
            // タイトルと本文を取得する
            val nameFood = binding.nameText.text.toString()
